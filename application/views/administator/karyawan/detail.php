<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
                                            ...
                                            <div class="modal fade" id="nonAktivasiModal" tabindex="-1" role="dialog" aria-labelledby="nonAktivasiModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah Anda yakin ingin menon-aktifkan karyawan ini?</p>
                                                            <label for="keterangan">Keterangan:</label>
                                                            <input type="text" name="keterangan" id="keterangan" class="form-control" placeholder="Masukkan keterangan (opsional)">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                            <a href="#" id="confirmNonAktivasi" class="btn btn-danger">Ya, Non-Aktifkan</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script>
            document.getElementById("confirmNonAktivasi").addEventListener("click", function() {
                var keterangan = document.getElementById("keterangan").value;
                var url = "<?= base_url('index.php/Administator/KelolaKaryawan/nonaktivasi/'.$detail['user_id']) ?>?keterangan=" + encodeURIComponent(keterangan);
