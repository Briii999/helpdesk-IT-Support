	...
	<div class="page-content fade-in-up">
		<div class="ibox">
			...
			<div class="ibox-body">
				...
				<?php endif; ?>
				<form class="form-horizontal" action="<?php echo site_url('Karyawan/KelolaPerangkat/updatePerangkat/'.$perangkat->id); ?>" method="POST" enctype="multipart/form-data" id="form-sample-1">
